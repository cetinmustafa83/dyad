import type { LanguageModel } from "../ipc_types";
...
export const MODEL_OPTIONS: Record<string, ModelOption[]> = {
  ...
  "claude-code": [
    // Claude Code CLI supports both Anthropic subscription models and custom provider models like Z.AI
    // The model selection is controlled by ~/.claude/settings.json configuration
    // Default behavior (sonnet/opus/haiku) maps to configured models via ANTHROPIC_DEFAULT_*_MODEL env vars
    
    {
      name: "sonnet",
      displayName: "Sonnet (Claude/GLM 4.7)",
      description:
        "Best balanced model. Maps to Claude Sonnet 4.5 (subscription) or GLM-4.7 (Z.AI custom mode).",
      maxOutputTokens: 32_000,
      contextWindow: 200_000,
      temperature: 0,
      dollarSigns: 0,
    ...
    {
      name: "opus",
      displayName: "Opus (Claude/GLM 4.7)",
      description:
        "Most powerful model. Maps to Claude Opus 4 (subscription) or GLM-4.7 (Z.AI custom mode).",
      maxOutputTokens: 32_000,
      contextWindow: 200_000,
      temperature: 0,
      dollarSigns: 0,
    ...
    {
      name: "haiku",
      displayName: "Haiku (Claude/GLM 4.6)",
      description:
        "Fast and efficient model. Maps to Claude Haiku 4 (subscription) or GLM-4.6 (Z.AI custom mode).",
      maxOutputTokens: 32_000,
      contextWindow: 200_000,
      temperature: 0,
      dollarSigns: 0,
    ...
    // Direct GLM Models (for explicit Z.AI selection)
    {
      name: "glm-4.7",
      displayName: "GLM-4.7",
      description:
        "Z.AI's latest and most powerful GLM model. Excellent for complex coding tasks.",
      maxOutputTokens: 32_000,
      contextWindow: 200_000,
      temperature: 0.7,
      dollarSigns: 0,
    ...
    },
    {
      ...
      displayName: "GLM-4.6",
      description:
        "Z.AI's fast GLM model. Great balance of speed and capability.",
      maxOutputTokens: 32_000,
      contextWindow: 128_000,
      temperature: 0.7,
      dollarSigns: 0,
